...
fs.readFile("code.json", "utf8", (err, data) => {
  ...
  obj = { NodeType: "BlockStmt", List: obj.Decls };
  console.log(obj);
  // compile_program(obj);
  // console.log(run(1000));
});

// Example of generated JSON from golang code
                    ...
                    Values: [
                      {
                        ...
                        Args: [
                          ...
                          { NodeType: "BasicLit", Kind: "INT", Value: "2" },
                        ],
                      },
                    ],
                  },
    ...
    Files: [
      {
        ...
        Base: 1,
        Size: 149,
        Lines: [0, 13, 14, 44, 58, 72, 89, 91, 92, 106, 107, 121, 146, 147],
        Infos: null,
      },
    ],
  },
...
console.log(json_code.Decls);

compile_program(json_code.Decls);
console.log(run(450));
